...
public class likeUp extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//-------------------------------------------------------------------- 1. 데이터 가져오기-------------------------------------------------------------------------------//
		// 이전 페이지 community_1.jsp의 a태그 <a href="likeUp?data=<%=c_list.get(idx).getC_idx()%>">
		// String타입 형변환
		// row는 커뮤니티 글의 인덱스 번호!
		...
		// 3-2. boardDAO의 likeUp 메소드 사용하여 반환 값 result에 저장
		...
		// 4-3. communityDAO의 Uplike 메소드 적용하기
		...
		// 5-3. 세션에 데이터를 넘긴 후에 main.jsp로 이동한다
